...
//
//
//class AlignPickup(private val swerveSubsystem: SwerveSubsystem, val cameraSubsystem: VisionSubsystem,private val lateralOffset: Distance,private val autoEnd: Boolean) : Command() {
//
...
//    private val tagAngles = mapOf(2 to 54) // 234.0)
...
//
//
//        val results= listOf("ATBack").map{ cam -> cameraSubsystem.io.getResults(cam)!!.map { it to cam } }.flatten()
//
//            //if (results)
//
//            /*val validResults =*/
...
//            }.filter {
////                true//it.first.fiducialId == selectedTag()
//                (tagAngles.contains(it.first.fiducialId))
//            }
...
//                        (this.targetId == 0 || this.targetId == it.first.fiducialId) && (tags.contains(it.first.fiducialId))
//                    }
...
//
//        if ( numTargets == 0) {
//            DriverStation.reportError("ENDING EXCUTE LOOP EARLY", false)
...
//
//        DriverStation.reportError("IT IS RUNNING THE STUPID MOVE COMMAND", false)
//
